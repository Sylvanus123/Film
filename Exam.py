...
local_file_path = r'D:\DATA MINING\movies.csv'
if os.path.exists(local_file_path):
    ...
    file_path = "~/.streamlit/DATA MINING/movies.csv"    

# Chargement des données
movies_df = pd.read_csv(file_path)

local_file_path = r'D:\DATA MINING\ratings.csv'
if os.path.exists(local_file_path):
    # Charger le fichier depuis le chemin absolu local
    file_path = local_file_path
else:
    # Charger le fichier depuis le chemin relatif sur Streamlit Cloud
    file_path = "~/.streamlit/DATA MINIGNG/ratings.csv"
